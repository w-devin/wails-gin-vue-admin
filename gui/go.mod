...
require (
	github.com/w-devin/poketto v0.0.0-20231130110527-fcb4db7b43bd
	github.com/wailsapp/wails/v2 v2.6.0
	go.uber.org/zap v1.26.0
	wails-gin-vue-admin v0.0.0-00010101000000-000000000000
)
...
// replace github.com/wailsapp/wails/v2 v2.6.0 => C:\Users\jarvis\.g\gopath\pkg\mod

replace wails-gin-vue-admin => ../
